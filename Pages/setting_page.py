...
class SettingPage:
    ...
    notification_add_email_input_xpath = "(//input[contains(@type,'email')])[2]"
    ...
    def manage_setting_page(self):
        ...
        element = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located((By.XPATH, self.setting_button_xpath)))
        element.click()